...
public class AfterEffect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("course").orderByChild("courseName").equalTo("Aftereffect");
        recyclerView = findViewById(R.id.recyclerview_aftereffect);
        list = new ArrayList<>();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new GridLayoutManager(AfterEffect.this, 1));
