...
public class K3D extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_k3_d);

        databaseReference = FirebaseDatabase.getInstance().getReference("course").orderByChild("courseName").equalTo("K3d");
        recyclerView = findViewById(R.id.recyclerview_k3d);
        list = new ArrayList<>();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new GridLayoutManager(K3D.this, 1));
