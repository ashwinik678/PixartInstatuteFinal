...
public class MovieMaker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("course").orderByChild("courseName").equalTo("Moviemaker");
        recyclerView = findViewById(R.id.recyclerview_moviemaker);
        list = new ArrayList<>();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new GridLayoutManager(MovieMaker.this, 1));
